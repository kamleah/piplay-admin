  ...
  useEffect(() => {
    if (edit == true) {
      ...
      reset({
        ...
        "tournament_court": editdata.tournament_court,
        ...
        "organizer_id": editdata?.organizer?._id,
        "team": editdata?.team,
        "venue_id": editdata?.venue?._id,
      ...
      if (editdata.tournament_category_ids.length > 0) {
        ...
        editdata.tournament_category_ids.map((data) => {
          const newdata = data
          newdata.start_date = moment(data.start_date).format("YYYY-MM-DD")
          newdata.end_date = moment(data.end_date).format("YYYY-MM-DD")
          return newdata
        })
      ...
      setCategoryDynamicFields([
        {
          ...
          match_type: [],
          rating: [],
          registration_fee: { per_person: '0', per_team: '0' },
          registration_fee_gst: { per_person_gst: '0', per_team_gst: '0' },
          registration_fee_price: { per_person_price: '0', per_team_price: '0' },
          per_person: '0',
          per_team: '0',
          max_registration: '',
          start_date: '',
          ...
          <form style={{ width: "100%" }} onSubmit={handleSubmit(onSubmit)}>
            <div className="form-container-grid-3 border-bottom-light">
              ...
              <div className="input-group">
                ...
                <label>Price per player <span style={{ color: "red" }}>*</span></label>
                <div className="form-group">
                  <input
                    type="number"
                    id="email"
              ...
              <div className="input-group">
                <label htmlFor="location">Event Type <span style={{ color: "red" }}>*</span></label>
                <div className="form-group">
                  <select
                    id="location"
              ...
              <div className="input-group">
                ...
                <label htmlFor="location">Event Court <span style={{ color: "red" }}>*</span></label>
                <div className="form-group">
                  <select
                    id="location"
                    {...register("tournament_court", {
                      required: {
                        value: true,
              ...
              <div className="input-group">
                <label htmlFor="contactNumber">Maximum Registers <span style={{ color: "red" }}>*</span></label>
                <div className="form-group">
                  <input
                    style={{ width: "106%" }}
                    type="number"
              ...
              <div className="input-group">
                <label htmlFor="location">Event Level</label>
                <div className="form-group">
                  <Controller
                    ...
                    render={({ field }) => (
                      <Select
                       styles={customStyles}
                        ...
                        isMulti
                        options={skills?.filter((item: any) => item?.data?.sport_type === Type)}
                        {...field}
                      />
                    )}
                  />
              ...
              <div className="input-group">
                <label htmlFor="location">Event Tag <span style={{ color: "red" }}>*</span></label>
                <div className="form-group">
                  <Controller
                    name="tournament_tag"
                    control={control}
              ...
              <div className="switch-container">
                <div className="form-subheadings">Add Categories</div>
                <Switch defaultChecked onChange={onChangeEnableBulkCategory} checked={enableBulkCategory} />
              </div>
              {/* Category form */}
              {enableBulkCategory && categoryDynamicFields?.map((field: any, index) => {
                return (
                  <div className="border-bottom-bold col-span-3 " key={index}>
                    ...
                    <div className="form-column form-container-grid-3">
                      ...
                      {field.packages?.map((packageField, packageIndex) => {
                        return (
                          <div className="border-bottom-light col-span-3 " key={packageField.id}>
                            <div className="col-span-3 form-subheadings-sm">Add Bulk Registration {packageIndex + 1}</div>
                            <div className="form-column form-container-grid-3">
                              <div className="input-group">
