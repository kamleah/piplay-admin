...
const HomePageTileDetails = ({ visible, name, onConfirm, onCancel, row }) => {
    const customTitle = (
            ...
            <div>
                ...
                <div className='grid-section border-bottom-light'>
                    ...
                    <div className="grid-item">
                        ...
                        <p className='info-value' >{row?.url_type ? row?.url_type : "____"}</p>
                    </div>
                    <div className="grid-item">
...
export default HomePageTileDetails