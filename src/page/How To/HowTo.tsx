...
import { deleteHowToAPI, filterHowToAPI, getHowToAPI } from '../../components/apiFile/Service';
import AddHowTo from '../../components/Modal/AddHowTo';
import HowToDetails from '../../components/Modal/HowToDetails';
import DeleteConfirmation from '../../components/Modal/DeleteConfirmation';
import { toast } from "react-toastify";
import ToastMessage from '../facilator/ToastMessage/ToastMessage';
import { gamesOptions } from './../../utils/reuse'

function HowTo({ matches, menuOpen, onToggle, modulePermissionsData }) {
    ...
    const getAllData = async () => {
        let response = await getHowToAPI(loggedInUser);
    ...
    const filterData = async (search, value) => {
        ...
        let response = await filterHowToAPI(loggedInUser,
    ...
    const DeleteFunction = async (id) => {
        ...
        let response = await deleteHowToAPI(loggedInUser, id);
        if (response.statusCode == 0) {
                    ...
                    <form className="">
                        <div className="main-title-container">
                            <div className="title-add-mobile">
                                <h5 className="main-content-title">How To</h5>
