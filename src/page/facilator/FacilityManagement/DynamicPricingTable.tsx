...
import { dynamicSlotPricing } from '../../../components/apiFile/Service';
    ...
    const columns: any = [
        ...
        ...column.map((court, index) => ({
            ...
            selector: (row: any, rowIndex: number) => {
                    ...
                    <>
                        {edit ? (
                            <div className="booking-container">
                                <Controller
                                    name={`slots.${slot.name}.${index}.${rowIndex}`} // Adjust this name as needed
                                    control={control}
                                    ...
                                    render={({ field }) => (
                                        <input
                                            ...
                                            id={`${slot.name}-${index}-${rowIndex}`}
                                            {...field}
                                            onChange={(e) => {
                                                field.onChange(e.target.value);
                                                handlePriceChange(e, slot, index);
                                            }}
                                        />
                                    )}
                                />
                ...
                //                             />
                //                         </span>
                //                         <span className="user">{`${slot.booking_data[0].user?.firstname || ''} ${slot.booking_data[0].user?.lastname || ''}`.trim()}</span>
