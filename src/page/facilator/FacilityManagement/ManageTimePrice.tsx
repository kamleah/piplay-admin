...
import { deleteCourt, deleteCourtTimePrice, filterCourt, filterCourtTimePrice, getAllCoaches, getAllCourt, getAllCourtTimePrice, getFacilityApi, getFacilityByIdApi } from "../../../components/apiFile/Service";
...
const ManageTimePrice = ({ matches, menuOpen, onToggle, modulePermissionsData }) => {
     ...
     const getAllCourts = async () => {
          ...
          if (!loggedUserDetails?.roleId) {
               ...
               response = await filterCourt(loggedInUser, '', facility_id?.value ||   ''  , "");
          }
     ...
     const getAllData = async () => {
          let response
          if (!loggedUserDetails?.roleId) {
               response = await getAllCourtTimePrice(loggedInUser);
          } else {
...
export default ManageTimePrice;
